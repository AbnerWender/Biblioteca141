    ...
    <div class="usuario-card">
        <header class="header-card">
            ...
            <div class="informacoes">
                <h2 class="usuario-card-titulo">ID: <p class="usuario-card-texto"><?= $usuario['id_usuario']?></p></h2>
        ...
        <footer class="footer-card">
            <button class="botao"><a href="updateUsuario.php" class="link-botao">Editar</a></button>
        </footer>
    </div>
</body>
</html>